...
url = '' # https://CLOUD.MYCLOUD.XYZ/index.php/apps/sensorlogger/api/v1/registerdevice/ -> NOTE: SLASH AT THE END is nescessary
...
def registerDevice():
    ...
    credentials = '%s:%s' % ('USERNAME', 'DEVICE TOKEN')
    ...
    # uncomment to print http response
    # print(r.data)
